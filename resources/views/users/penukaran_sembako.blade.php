        ...
        <div class="mb-4">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="policy" role="tabpanel" aria-labelledby="policy-tab">
                    <h4 class="mt-4 pt-2">Persyaratan</h4>
                ...
                <div class="tab-pane fade" id="barter" role="tabpanel" aria-labelledby="barter-tab">
                    <h4 class="mt-4 pt-2">Penukaran</h4>
                    <p>Lengkapi data yang dibutuhkan agar proses pengantaran sembako dapat diselesaikan hingga sukses.</p>
