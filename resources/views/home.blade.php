...
@section('content')
    ...
    <div class="row align-items-center justify-content-between mb-5">
        <div class="col-md-7">
            ...
            <a class="btn barter-bage-color text-white py-3 px-5 rounded-lg fw-bold" href="/penukaran">Tukar Sampah</a>
        </div>
        <div class="col-md-5">
    ...
    {{-- middle home --}}
    <div class="row align-items-center justify-content-between my-5 py-4">
        <div class="col-12">
            <h4 class="text-center mb-5 fw-bold">Mengapa BarterBage?</h4>
        </div>
